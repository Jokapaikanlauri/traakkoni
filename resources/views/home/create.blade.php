...
<html lang="en">
  ...
  <body>
    ...
    <script>
      const CONFIGURATION = {
        "defaultTravelMode": "BICYCLING",
        "distanceMeasurementType": "METRIC",
        "mapOptions": {"center":{"lat":60.16985569999999,"lng":24.938379},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":14,"zoomControl":true,"maxZoom":20,"mapId":""},
        "mapsApiKey": "AIzaSyCq-kOTVIXT9u1_YXEsDbEBCIW3FQwYPZ4"
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCq-kOTVIXT9u1_YXEsDbEBCIW3FQwYPZ4&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v2_c" async defer></script>
  </body>
</html>